            ...
            onPress={() => navigation.navigate("HotelDetailScreen", hotel)}>
                <View style = {style.CardHotel}>
                    ...
                    <View style ={style.cardText}>
                        <Text style={{color: 'black', fontSize: 16, fontWeight: 'bold'}} numberOfLines={1} ellipsizeMode='tail'>{hotel.name}</Text>
                        <View style={{height: 2, backgroundColor:'black'}}/>
                        <View style={{flexDirection: 'row'}}>
                            <Text>
                                {hotel.star}
                            </Text>
                            <MaterialIcons name = 'star' size={15} style={{color:'orange', marginTop: 1}}/>
                        </View>
                        <View style={{flexDirection: 'row'}}>
                            <MaterialIcons name = 'monetization-on' size={14} style={style.iconDetail}/>
                            <Text style={{ ...style.textDetail, color: COLORS.orange,}}>
                                {hotel.price} đ
                            </Text>
                        </View>
                        <View style={{flexDirection: 'row'}}>
                            <Ionicons name ='location-sharp' size={14} style={style.iconDetail}/>
                            <Text style={{...style.textDetail, color: COLORS.darkgrey}}>
                                {hotel.location}
                            </Text>
                        </View>
                        <View style={{flexDirection: 'row'}}>
                            <MaterialIcons name ='room-service' size={14} style={style.iconDetail}/>
                            <Text style={{...style.textDetail, color: COLORS.lightblue}} numberOfLines={2} ellipsizeMode='tail'>
                                {hotel.services}
                            </Text>
                        </View>
                        <View style={{flexDirection: 'row'}}>
                        ...
                        <Rating type='star' style={style.starRating} ratingCount={5} imageSize={12} startingValue={hotel.starRating} readonly={true}/>
                        </View>
                    </View>
                </View>
            </TouchableHighlight>
    ...
    return (
        <SafeAreaView style={{flex: 1, backgroundColor: COLORS.white}}>
            ...
            <View style={style.header}>
                <Feather name= 'arrow-left' size = {25} color = {COLORS.white} onPress={() =>{navigation.navigate("HomeScreen");}}/>

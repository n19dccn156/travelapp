    ...
    <View>
      ...
      <View style={HeaderStyle.topButtons}>
        ...
        <View style={style.rowCenter}>
          <Ionicons name= 'map-sharp' size = {25} color={COLORS.white} style={HeaderStyle.topButtonsRight}/>
          <Ionicons name= 'images' size = {25} color={COLORS.white} style={HeaderStyle.topButtonsRight}/>
          <Entypo name= 'share' size ={25} color={COLORS.white} style={HeaderStyle.topButtonsRight}/>
        </View>
    </View>
